...
class BaseModel(ABC):
    ...
    def __init__(self, opt, manager):
        ...
        # If test: the result dir run_name is e.g ModelTest: We need the ckp dir is Model
        self.save_dir = manager.get_checkpoint_dir(run_name=opt.run_name.replace('Test',''))
        self.loss_names = []
        self.model_names = []
        self.visual_names = []
