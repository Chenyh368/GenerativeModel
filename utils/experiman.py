...
class ExperiMan(object):
    ...
    def get_basic_arg_parser(self):
        ...
        # ======> Setting run_dir
        parser.add_argument('--log_dir', type=str, default="/root/Log", help="root dir for logging")
        parser.add_argument('--exp_name', type=str, default="GenerativeModel", help="name of the experiment")
        parser.add_argument('--run_name', type=str, default="CycleGAN", help="name of this run")
