...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--drop_last', action='store_true',
                            help='if true, the dataloader will drop last batch')
        parser.add_argument('--num_threads', default=4, type=int, help='# threads for loading data')
        parser.add_argument('--batch_size', type=int, default=1, help='input batch size')
        parser.add_argument('--dataset_dir', default="maps",
                            help='path to images (should have subfolders trainA, trainB, valA, valB, etc) e.g. maps')
    ...
    def parse(self):
        ...
        opt.dataroot = os.path.join(opt.data_dir, opt.dataset_dir)
